...
const projects = [
  { id: 1, title: 'DigiCam Market', description: 'Full-stack e-commerce with auth, real-time chat, admin dashboard.', longDescription: 'Modern e-commerce with Next.js 15, NextAuth, Redux, WebSocket chat, coupon system, and advanced security.', image: '/digiCamCoverPic.png', technologies: ['Next.js','React','MongoDB','NextAuth','Redux','Socket.io','Tailwind'], liveUrl: 'https://digicammarket.com', githubUrl: 'https://github.com/rianhasansiam/digicam', featured: true },
  ...
  { id: 4, title: 'COZYSTAY Hotel', description: 'Hotel booking with room listings and availability.', image: '/assignment11.png', technologies: ['React','Node.js','MongoDB','Firebase','Tailwind'], liveUrl: 'https://cozystay-hotel-booking.web.app/', githubUrl: 'https://github.com/rianhasansiam/Hotel_COZYSTAY_Client_Side', featured: false },
  { id: 5, title: 'Visa Navigator', description: 'Visa info with country-specific requirements.', image: '/visanavigator.png', technologies: ['React','Node.js','Express.js','MongoDB','CSS3'], liveUrl: 'https://visa-navigator-client.web.app/', githubUrl: 'https://github.com/rianhasansiam/visa-navigator-client', featured: false },
  { id: 6, title: 'Linggo Bingo', description: 'Interactive language learning with gamification.', image: '/LinggoBingo.png', technologies: ['React','Node.js','Express.js','MongoDB'], liveUrl: 'https://linggo-bingo-fc382.web.app/', githubUrl: 'https://github.com/rianhasansiam/linggo-bingo-client', featured: false },
]
              ...
              <div key={p.id} ref={el => cardsRef.current[i] = el} className={`project-card-scroll group ${p.featured ? 'lg:col-span-2' : ''}`}>
                <div className={`flex ${p.featured ? 'flex-col md:flex-row' : 'flex-col'}`}>
                  <div className={`relative overflow-hidden ${p.featured ? 'md:w-1/2 h-64 md:h-auto' : 'h-52'}`}>
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-[#070714] via-[#070714]/30 to-transparent" />
                  ...
                  <div className={`p-6 flex flex-col ${p.featured ? 'md:w-1/2' : ''}`}>
                    ...
                    <div className="flex flex-wrap gap-1.5 mb-5">{p.technologies.slice(0,5).map(t => <span key={t} className="px-2.5 py-1 bg-white/[0.03] border border-white/[0.06] text-white/40 rounded-md text-[10px] font-medium">{t}</span>)}</div>
